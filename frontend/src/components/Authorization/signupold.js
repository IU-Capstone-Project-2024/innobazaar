...
function UserRegistration(isVendor) {
            ...
            <div id="registration-window">
                ...
                <div className="main-content">
                    ...
                    <form id="registration-form" onSubmit={event => event.preventDefault()}>
                        ...
                        <button className="wide_button" id="bottom_sign_up" onClick={() => UserRegistration(false)}>SIGN UP AS USER
                        </button>
                        <button className="wide_button" id="bottom_sign_up_vendor" onClick={() => UserRegistration(true)}>SIGN UP AS
                            VENDOR
                        </button>
                    </form>
                </div>
